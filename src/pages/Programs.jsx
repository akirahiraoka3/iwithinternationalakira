...
const Programs = () => {
  const purposes = [
    { id: 1, name: '短期留学', description: '1週間から3ヶ月の短期留学や、学校休暇中の語学研修', image: 'https://cdn.midjourney.com/7f44fccc-cf3f-4636-a0d4-5128b3583c3a/0_0.png', link: '/short-term-study' },
    { id: 2, name: '長期留学', description: '高度な語学力とスキルを身につける3ヶ月以上の長期留学', image: 'https://cdn.midjourney.com/3e0ea157-2368-4536-9664-c6151c7062a1/0_1.png', link: '/long-term-study' },
